...
const service_data = [
  {
    id: 1,
    img: ser_img_1,
    subtitle: "Signage Design",
    title: "Indoor & Outdoor Signage",
    text: "High-impact indoor and outdoor signage designs that capture attention and effectively communicate your message.",
    lists: [
      "Banner Design",
      "Poster Design",
      "Storefront Signage",
  ...
  },
  {
    ...
    img: ser_img_2,
    subtitle: "Signage Design",
    title: "Large Format & Commercial Graphics",
    text: "Large-format commercial graphics designed for maximum visual impact and professional presentation.",
    lists: [
      "Vehicle Wrap Design",
...
export default function SignageAfterBefore() {
  return (
